...
class Event:
    ...
    Events are sorted by their time and priority. Events with lower times come
    before events with higher times.
    ...
    Attributes:
        ...
        priority (int): the priority of the event, lower value denotes a
            higher priority.
    ...
    def __eq__(self, another):
        return (self.time == another.time) and (self.priority == 
                                                another.priority)

    def __ne__(self, another):
        return (self.time != another.time) or (self.priority != 
                                               another.priority)

    def __gt__(self, another):
        return (self.time > another.time) or (self.time == another.time and 
