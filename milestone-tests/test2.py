"""
Example SeQUeNCe script for creating and measuring photons
...
if __name__ == "__main__":
    ...
    print(f"Old runtime: {runtimes[0]}")
    print(f"New runtime: {runtimes[1]}")
    print(f"Old per photon: {runtimes[0]/SAMPLE_SIZE}")
    print(f"New per photon: {runtimes[1]/SAMPLE_SIZE}")